...
const URL = url.URL;
const myURL = new URL('https://www.integralist.co.uk/posts/cognito/#authentication-vs-authorization');
...
console.log('--------');
const parsedUrl = url.parse('https://www.integralist.co.uk/posts/cognito/#authentication-vs-authorization');
...
console.log('url.format():', url.format(parsedUrl)); // => url.format(): https://www.integralist.co.uk/posts/cognito/#authentication-vs-authorization
